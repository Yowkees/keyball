...
※Keyball46が完成したら、USBケーブルはトラックボールを取り付けた側に接続して使用します。そうしないとトラックボールが機能しません。
...
お疲れ様でした。  
※なお、現在のファームウェアではUSBケーブルはトラックボールを取り付けた側のProMicroに接続してください。反対側に接続するとトラックボールが動きません。
