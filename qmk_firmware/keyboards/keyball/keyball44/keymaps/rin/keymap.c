...
const uint16_t PROGMEM nicola_pa[]     = {LT(5, KC_LGUI), NICOLA_RA, COMBO_END};
const uint16_t PROGMEM nicola_di[]     = {LT(5, KC_LGUI), NICOLA_TI, COMBO_END};
const uint16_t PROGMEM nicola_gu[]     = {LT(5, KC_LGUI), NICOLA_KU, COMBO_END};
const uint16_t PROGMEM nicola_du[]     = {LT(5, KC_LGUI), NICOLA_TU, COMBO_END};
const uint16_t PROGMEM nicola_pi[]     = {LT(5, KC_LGUI), KC_COMM, COMBO_END};
...
const uint16_t PROGMEM nicola_pu[]     = {LT(5, KC_LGUI), NICOLA_ME, COMBO_END};
const uint16_t PROGMEM nicola_zo[]     = {LT(5, KC_LGUI), NICOLA_SO, COMBO_END};
const uint16_t PROGMEM nicola_pe[]     = {LT(5, KC_LGUI), NICOLA_NE, COMBO_END};
const uint16_t PROGMEM nicola_bo[]     = {LT(5, KC_LGUI), NICOLA_HO, COMBO_END};
