...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL  , KC_LALT  , KC_LGUI  , LT(1,KC_LNG2), LT(2,KC_SPC), LT(3,KC_LNG1),    KC_BSPC, LT(2,KC_ENT), LT(1,KC_LNG2), KC_RGUI, KC_RALT
  ),
  ...
  [1] = LAYOUT(
    ...
    S(KC_LCTL), S(KC_LALT), S(KC_LGUI), _______, _______, _______,           _______, _______, _______, S(KC_RGUI), S(KC_RALT)
  ),
  ...
  [2] = LAYOUT(
    ...
    _______  , _______  , KC_0     , KC_DOT   , _______  , _______  ,           _______  , KC_DEL  , _______  , _______  , _______
  ),
  ...
  [3] = LAYOUT(
    ...
    QK_BOOT  , _______  , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  ,           _______  , KC_BSPC  , _______  , _______  , _______  , _______  , QK_BOOT, KC_NO
),
  ),
};
